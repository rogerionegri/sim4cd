PRO FUNCTION_SIM_4_CD__V3__withSegGen, vecDefs, PATH_SAVE, PATH_IMG, PATH_ROI, PREFIX_PHT, PREFIX_SIM, PREFIX_SEGM, METAFILE, seed, distOpt, randPerc
  ...
  FOR s = 0, N_ELEMENTS(vecDefs)-1 DO BEGIN
    ...
    PRO_GAUSSIAN_SIMULATION_PHANTOM_PAIR_CHANGE_DETECTION__v3__withSEGM, PATH_IMG, PATH_ROI, supportFill, supportFillDist, PATH_SAVE, PREFIX_SIM, PREFIX_PHT, PREFIX_SEGM, STRTRIM(STRING(s+1),1), ParsGauss, distOpt, seed, randPerc, correlationWindow
