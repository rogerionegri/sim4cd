PRO PRO_GAUSSIAN_SIMULATION_PHANTOM_PAIR_CHANGE_DETECTION__V3, PATH_IMG, PATH_ROI, Phantom1, Phantom2, PATH_SAVE, PREFIX_SIM, PREFIX_PHT, info, ParsGauss, distOpt, seed, randPerc, correlationWindow
  ...
  PATH_OUT_IND_T1 = PATH_SAVE+PREFIX_PHT+info+'--ROI_T1.txt'
  PATH_OUT_IND_T2 = PATH_SAVE+PREFIX_PHT+info+'--ROI_T2.txt'
